...
function View({ paperId }) {
    ...
    const loadAttempts = () => {
        fetch(`/api/admin/papermarking/${paperId}`)
    ...
    return (
        <div className="p-4">
            <h1 className="text-xl font-semibold text-gray-800 mb-6">Attempts for Paper {paperId}</h1>
...
export default function PaperAttemptsPage({ params }) {
    ...
    return (
        <AuthLoading>
            <DashboardLayout>
                ...
                <h1 className="text-3xl font-semibold text-gray-800 mb-6">Paper Attempts</h1>
